...
Note: that the image in the instructions below is not yet ready to be released. If you would like to get access to a beta-test version of this image, send an e-mail to :email:`jon@ninjablocks.com`.
